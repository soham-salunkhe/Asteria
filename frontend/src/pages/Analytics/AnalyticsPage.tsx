      ...
      <div className="analytics-summary-row">
        <TelemetryPanel
          ...
          fields={[
            ...
            { label: 'AVG ERR PX',   value: met?.average_error_px?.toFixed(2) ?? '—', unit: 'px' },
            { label: 'MAX ERR PX',   value: met?.max_error_px?.toFixed(2) ?? '—', unit: 'px', warn: (met?.max_error_px ?? 0) > 10 },
            { label: 'RMSE PX',      value: met?.rmse_px?.toFixed(2) ?? '—', unit: 'px', highlight: (met?.rmse_px ?? 99) <= 10 },
